<div class="templates index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('template_category_id'); ?></th>
			<th><?php echo $this->Paginator->sort('name'); ?></th>
			<th><?php echo $this->Paginator->sort('thumbnail_path'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($template['Template']['thumbnail_path']); ?>&nbsp;</td>
